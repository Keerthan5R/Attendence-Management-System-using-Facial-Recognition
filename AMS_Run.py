...
window = tk.Tk()
window.title("Attendence Management System using Facial Recognition-AMSFR")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Keerthan R/Downloads/CODSOFT-main (2)/CODSOFT-main/portfolio/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,""C:/Users/Keerthan R/Downloads/CODSOFT-main (2)/CODSOFT-main/portfolio/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = '"C:/Users/Keerthan R/Downloads/CODSOFT-main (2)/CODSOFT-main/portfolio/Face-Recognition-Attendance-System-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/Keerthan R/Downloads/CODSOFT-main (2)/CODSOFT-main/portfolio/Face-Recognition-Attendance-System-main/Attendance-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'keerthan':
            if password == '123':
                ...
                cs = 'C:/Users/Keerthan R/Downloads/CODSOFT-main (2)/CODSOFT-main/portfolio/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="FACE-DETECTION-ATTENDENCE-SYSTEM", bg="black", fg="white", width=50,
...
lbl = tk.Label(window, text="Enrollment Number: ", width=20, height=2,
               fg="black", bg="grey", font=('times', 15, 'bold'))
...
AP = tk.Button(window, text="ADMIN PANEL", command=admin_panel, fg="black",
               bg="SkyBlue1", width=19, height=1, activebackground="white", font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Photo", command=take_img, fg="black", bg="SkyBlue1",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Model", fg="black", command=trainimg, bg="SkyBlue1",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
